...
try:
    ...
    st.error("Failed to import the 'ultralytics' package. Make sure it is installed correctly.")

# Check if YOLO model can be loaded
try:
    model = YOLO("yolov8l.pt")
except NameError:
    st.error("YOLO model could not be loaded. Ensure 'ultralytics' is installed and the model path is correct.")
